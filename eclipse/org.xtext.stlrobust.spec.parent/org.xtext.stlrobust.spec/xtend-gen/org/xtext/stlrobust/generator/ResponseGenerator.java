...
public class ResponseGenerator extends SpecGenerator {
  public static Object generate(final Specification spec) {
    ...
    if ((_scope_1 instanceof GlobalScope)) {
      _matched=true;
      return ResponseGenerator.genGlobalScope(spec);
    }
    if (!_matched) {
      Scope _scope_2 = spec.getScope();
      if ((_scope_2 instanceof BeforeScope)) {
        _matched=true;
        return ResponseGenerator.genBeforeScope(spec);
      }
    }
    if (!_matched) {
      ...
      if ((_scope_3 instanceof AfterScope)) {
        _matched=true;
        return ResponseGenerator.genAfterScope(spec);
      }
    }
    if (!_matched) {
      ...
      if ((_scope_4 instanceof BetweenScope)) {
        _matched=true;
        return ResponseGenerator.genBetweenScope(spec);
      }
    }
    if (!_matched) {
      ...
      if ((_scope_5 instanceof AfterUntilScope)) {
        _matched=true;
        return ResponseGenerator.genAfterUntilScope(spec);
      }
    }
  ...
  public static String genGlobalScope(final Specification spec) {
    ...
    Response pattern = ((Response) _pattern);
    String p = SpecGenerator.expression(pattern.getP());
    String s = SpecGenerator.expression(pattern.getS());
    String t = SpecGenerator.time(pattern.getTime());
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("always[0,0](");
    _builder.append(p);
    _builder.append("implies(eventually");
    _builder.append(t);
    _builder.append(s);
    _builder.append("))");
